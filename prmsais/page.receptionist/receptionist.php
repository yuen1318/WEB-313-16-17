...
<!--- /////////////////////// NAVBAR //////////////////////////////////--->
      <div class="navbar-fixed">
        <nav class="navbar-wrapper blue darken-1">
          <a href="#" class="brand-logo center">Receptionist</a>
...
<!--- /////////////////////// SIDE NAV //////////////////////////////////--->
      <ul class="side-nav fixed blue darken-1" id="show-sidenav" >
        ...
        <li><a href="#organizePatient" class="waves-effect"><i class="fa fa-plus-square"></i>Organize Patient</a></li>
        <li><div class="divider"></div></li>
...
<main>
      <div ng-view></div><!-- where the routing happens-->

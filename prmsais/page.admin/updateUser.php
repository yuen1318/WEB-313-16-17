...
<div class="row">
 <div class="col s12">
   ...
   <div class="input-field">
     ...
     <input type="text"  id="user_id" ng-model="user_update.id" readonly>
   </div>

   <div class="input-field">
     <label for="pw"><i class="fa fa-map-marker" ></i>   Password</label>
     <input type="text"  id="pw" ng-model="user_update.pw">
   </div>


   <div class="input-field">
     <label for="type"><i class="fa fa-map-marker" ></i>   Accessability</label>
     <input type="text"  id="type" ng-model="user_update.type">
   </div>

   <div>
     <button data-target="modal_update_user" class="btn modal-trigger">Update</button>
   </div>
...
<div id="modal_update_user" class="modal">
 ...
 <div class="modal-footer">
   <a  class="btn waves-effect right blue darken-1 modal-action modal-close"  href="#/organizeUser" ng-click="updateUser_tbl()">Yes</a>

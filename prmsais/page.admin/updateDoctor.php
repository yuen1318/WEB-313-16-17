...
<div class="row">
 <div class="col s12">
   ...
   <div class="input-field">
     ...
     <input type="text"  id="doctor_id" ng-model="doctor_update.id" readonly>
   </div>

   <div class="input-field">
     <label for="name"><i class="fa fa-map-marker" ></i>   Name</label>
     <input type="text"  id="name" ng-model="doctor_update.name">
   </div>


   <div class="input-field">
     <label for="med_title"><i class="fa fa-map-marker" ></i>   Medical Title</label>
     <input type="text"  id="med_title" ng-model="doctor_update.medical_title">
   </div>

   <div>
     <button data-target="modal_update_doctor" class="btn modal-trigger">Update</button>
   </div>
...
<!-- Modal Structure -->
<div id="modal_update_doctor" class="modal">
 <div class="modal-content">
   <h4>Confirmation</h4>
   <p>Are you sure you want to edit this data?</p>
 </div>
 <div class="modal-footer">
   <a  class="btn waves-effect right blue darken-1 modal-action modal-close"  href="#/organizeDoctor" ng-click="updateDoctor_tbl()">Yes</a>
